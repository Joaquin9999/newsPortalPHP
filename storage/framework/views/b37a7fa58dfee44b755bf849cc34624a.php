...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                style="color: #0017f1; hover-color: #0017f1; focus:ring-color: #0017f1;" href="<?php echo e(route('login')); ?>">
...
<?php endif; ?><?php /**PATH /home/neji21/Documents/php/newsPortalPHP/resources/views/auth/register.blade.php ENDPATH**/ ?>